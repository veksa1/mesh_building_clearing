...
export function SimCanvas({
  ...
  useEffect(() => {
    ...
    // 4. Mesh comm links — colored by message type, faded by age.
    ...
    // 5. Entrance marker (always visible).
    {
    ...
    // 6. Target marker — always visible (oracle view).
    ...
    // 7. Room anchors with IDs (oracle).
    ...
    // 8. Drones (last layer — always on top).
  ...
  }, [frame, compiled, params, wallBitmap, recentLinks]);
